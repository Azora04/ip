...
Check that the page exists and that the generator's summary reports the expected changed-file count. For a visual review, open the generated HTML file in the Codex browser or inspect its rendered page when the user asks.
